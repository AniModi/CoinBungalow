    ...
    <>
      ...
      >
        ...
        <div className="landing_page_section__left">
          <div className="landing_page_section__left__title">{title}</div>
          <div className="landing_page_section__left__body">
            <div className="landing_page_section__left__body__text">{body}</div>
            <div className="landing_page_section__left__body__btn_container">
              <motion.button
                className="landing_page_section__left__body__btn_container__btn"
                onClick={handleClick}
